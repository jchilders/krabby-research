#!/usr/bin/env bash
# Play bundled teacher 2b1 baseline (Appendix E).
# Usage: play_crab_hex_2b1_baseline.sh <path-to-usda> <path-to-model.pt>
set -euo pipefail
...
echo "Playing crab hex teacher 2b1 baseline"
